...
/* ---------------- HERO ENERGY SPARKS (soft streaks) ---------------- */
(function(){
  ...
  var sparks = [];
  function spawn(){ sparks.push({ x: Math.random()*canvas.width/DPR, y: 20+Math.random()*80, vx:(Math.random()-.5)*0.6, vy:0.3+Math.random()*0.6, life: 1 }); }
